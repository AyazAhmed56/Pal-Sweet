...
const Namkeen = () => {
  ...
  return (
    <div>
      <img
        src="https://www.haldirams.com/media/catalog/tmp/category/namkeen.jpg"
        alt="Namkeen_image"
        className="p-5"
      />
      <h1 className="mt-5 font-bold text-5xl text-center">Namkeen</h1>
      ...
      <div className="flex flex-col lg:flex-row gap-10 mt-10 px-4 lg:px-10">
        ...
        <div className="w-full max-w-sm p-6 rounded-2xl shadow-2xl">
            ...
            {showPrice && (
              <>
                <div className="m-3 flex justify-between items-center">
                  <h1 className="border p-3 shadow text-sm">
                    ₹{sliderValue[0]}
                  </h1>
                  <h1 className="border p-3 shadow text-sm">
                    ₹{sliderValue[1]}
          ...
          <p className="pt-10 text-xl font-normal">
              ...
              <Link to={`/sweet/${item.id}`}>
                ...
                >
                  <img
                    src={item.image}
                    alt={item.name}
                    className="object-cover h-[170px] w-full rounded-md shadow"
                  />
