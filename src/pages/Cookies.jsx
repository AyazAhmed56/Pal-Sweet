...
const Cookies = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFF8D0]">
      <motion.img
        src="https://www.haldirams.com/media/catalog/category/Cookies.jpg"
        alt="Cookies Banner"
            ...
            {showPrice && (
              <>
                <div className="flex justify-between mt-4 text-sm">
                  <span className="border px-3 py-1 rounded shadow">
                    ₹{sliderValue[0]}
                  </span>
                  <span className="border px-3 py-1 rounded shadow">
                    ₹{sliderValue[1]}
                ...
                <div className="grid grid-cols-2 gap-3">
                  {availableSizes.map((size) => (
                    <Button
                      key={size}
                      variant={
                        selectedSize === size ? "destructive" : "outline"
                      }
                      onClick={() => {
            ...
            >
              <Link to={`/sweet/${item.id}`}>
                <img
                  src={item.image}
                  alt={item.name}
                  className="w-full h-56 object-cover rounded-xl transition group-hover:opacity-80"
                />
